...
const SPHERE_INTROS = {
  ...
  shops: "Кабинет магазина: каталог товаров, склад, заказы и доставка.",
...
export function buildPlatformTourSteps({ role, sphere, isBookmarkAvailable }) {
  ...
  if (sphere === "marketplaces") {
    ...
    nav("shop", "Магазин / склад", "Каталог товаров, остатки, заказы и доставка.");
    nav("analytics", "Аналитика", "Статистика по продажам и заказам.");
  } else {
