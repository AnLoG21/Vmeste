...
const BUSINESSES = [
  ...
  },
  {
    ...
    accent: "#2f5d50",
    title: "Автосервис",
    lead: "Запись на ТО и ремонт, VIN и госномер, интерактивная приёмка и статусы работ для клиента.",
    highlights: [
      "Каталог: ТО, ходовая, двигатель, электрика",
      "VIN и госномер в карточке приёмки",
      "Интерактивная приёмка: фото, галочки клиента, акт и заказ-наряд",
      "Статусы ремонта для клиента: в работе / готов",
      "Связь записи и приёмки, механики и интервалы",
    ],
    categories: [
      { name: "Работы", items: ["ТО и диагностика", "Ходовая и тормоза", "Двигатель и электрика"] },
      { name: "Приёмка", items: ["VIN и госномер", "Фото дефектов", "Согласование с клиентом"] },
      { name: "Клиенты", items: ["Онлайн-запись", "Статусы ремонта", "Чат и уведомления"] },
    ],
  },
  {
    id: "cafe_restaurant",
  ...
  },
  {
    ...
    accent: "#1565c0",
    title: "Маркетплейсы",
    lead: "Кабинет продавца Ozon и Wildberries внутри Вместе: ключи площадок, карточки товаров, остатки, заказы, аналитика и отзывы — без отдельной регистрации.",
    highlights: [
      "Ключи Ozon и Wildberries хранятся у организации",
      "Создание и пакетная выгрузка карточек, CSV",
      "Цены, остатки, медиа на нашем хранилище",
      "Заказы, склады, поставки WB, аналитика и отзывы",
    ],
    categories: [
      { name: "Товары", items: ["Карточки Ozon и WB", "Пакетная выгрузка и CSV", "История выгрузок"] },
      { name: "Склад", items: ["Цены и остатки", "Склады площадок", "Поставки Wildberries"] },
      { name: "Продажи", items: ["Заказы FBS", "Аналитика", "Отзывы и вопросы"] },
    ],
  },
  {
    id: "shops",
    ...
    accent: "#6a4c93",
    title: "Магазины",
    lead: "Свой каталог товаров, склад, самовывоз и доставка через Вместе — с витриной для клиентов на карте.",
    highlights: [
      "Категории и товары с фото и характеристиками",
      "Остатки и списание по заказам",
      "Самовывоз и доставка: свой курьер, Яндекс, СДЭК, Почта, Dostavista",
      "Публичная витрина /s/… и заказы в кабинете",
    ],
    categories: [
      { name: "Каталог", items: ["Категории", "Товары и фото", "Популярные на карте"] },
      { name: "Склад", items: ["Приход и списание", "Остатки", "Материалы услуг"] },
      { name: "Заказы", items: ["Оплата онлайн", "Самовывоз и доставка", "Статусы сборки"] },
    ],
  },
];
...
const FAQ = [
  {
    ...
    answer:
      "Есть готовые сценарии для салонов красоты, сервисных центров, кафе/ресторанов, магазинов и продавцов маркетплейсов. Другие сферы — через индивидуальную автоматизацию.",
  },
  {
  ...
  {
    question: "Что даёт сфера «Маркетплейсы»?",
    answer:
      "Это B2B-кабинет селлера: ключи Ozon и Wildberries, выгрузка товаров, заказы, склады, аналитика и отзывы. Такие организации не показываются на публичной карте клиентов.",
  },
];
...
export default function BusinessesPage() {
  useEffect(() => {
    setPageMeta({
      title: "Для бизнеса — салоны, сервисы, кафе и маркетплейсы | Вместе",
      description:
        "Вместе для салонов красоты, сервисных центров, кафе и продавцов Ozon/Wildberries: кабинеты, чаты и готовые сценарии.",
      path: "/businesses",
    });
  }, []);
