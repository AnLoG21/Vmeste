        ...
        <section className="landing-section" id="integrations">
          ...
          <div className="landing-notify-strip">
            ...
            <article>
              <h3>Календари</h3>
              <p>
                Google и Яндекс Календарь — подписка по ICS-ссылке из настроек организации.
                Расписание мастер ведёт в Вместе.
              </p>
            </article>
          </div>
          ...
          <div className="landing-roadmap-grid">
            <article className="landing-roadmap-card landing-roadmap-card--now">
              ...
              <ul>
                ...
                <li>Печать QR-карточек столов и меню; экран кухни со звуком новых заказов</li>
                <li>Зоны доставки на карте (полигоны) с отдельной ценой и минимумом</li>
