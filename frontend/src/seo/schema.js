...
export const HOME_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Сейчас — в личном кабинете, в чате с организацией и push в приложении Вместе (Android и iOS). SMS, Telegram-бот и WhatsApp — в подключении. Google Календарь и Яндекс Календарь синхронизируются отдельно, также в подключении.",
  },
  {
