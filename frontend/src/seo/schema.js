...
export const HOME_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Уже есть готовые сценарии для салонов красоты, сервисных центров, кафе/ресторанов и продавцов маркетплейсов (Ozon и Wildberries). Другие сферы можно подключить через индивидуальную автоматизацию.",
  },
  {
