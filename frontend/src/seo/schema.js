...
export const HOME_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Для кафе доступна онлайн-оплата заказов через ЮKassa. Борьба с неприходами: частичная или полная предоплата за услуги через встроенный эквайринг — модуль в подключении; до штатного запуска можно обсудить кастом.",
  },
];
