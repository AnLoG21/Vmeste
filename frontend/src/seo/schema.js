...
export const HOME_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Сейчас — в личном кабинете, в чате с организацией, email и push в Android-приложении. SMS, Telegram, WhatsApp и MAX — исходящие уведомления при настроенных ключах организации. Двусторонней переписки в мессенджерах пока нет. Google и Яндекс Календарь — подписка по ICS.",
  },
  {
