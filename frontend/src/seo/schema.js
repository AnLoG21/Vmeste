...
export const HOME_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Для кафе доступна онлайн-оплата заказов через ЮKassa. Предоплата при записи на услуги (частичная/полная) — в планах развития; до появления штатной функции можно обсудить кастом в рамках автоматизации.",
  },
];
