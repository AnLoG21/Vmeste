...
function bookmarkMenuIcon(id) {
  const icons = {
    ...
    clients: {
      color: "#6a1b9a",
      d: "M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V6h16v12zM4 0h16v2H4zm0 22h16v2H4zm8-14c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 8.2c2.5 0 4.5-1.02 4.5-2.28V15h-9v.92c0 1.26 2 2.28 4.5 2.28z",
    },
    my_bookings: {
      color: "#ef6c00",
