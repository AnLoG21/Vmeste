...
class CafeOrder(models.Model):
    ...
    delivery_apartment = models.CharField(max_length=32, blank=True, default="")
    delivery_entrance = models.CharField(max_length=32, blank=True, default="")
    delivery_intercom = models.CharField(max_length=64, blank=True, default="")
    delivery_private_house = models.BooleanField(default=False)
