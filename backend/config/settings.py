...
CELERY_BEAT_SCHEDULE = {
    ...
    "marketplaces-poll-orders-every-10-min": {
...
ASTERISK_AMI_PORT = int(os.environ.get("ASTERISK_AMI_PORT", "5038") or 5038)
ASTERISK_AMI_USER = os.environ.get("ASTERISK_AMI_USER", "vmeste").strip()
