...
| Spec | Scenarios |
|------|-----------|
| `android.spec.js` | RuStore CTA + APK fallback vs PWA |
...
| `provider-inspection-repair.spec.js` | /inspections → approved → Запчасти → Готов → Выдан |
